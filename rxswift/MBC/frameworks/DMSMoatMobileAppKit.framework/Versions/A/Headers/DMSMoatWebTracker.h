 ...
 */
@interface DMSMoatWebTracker : DMSMoatBaseTracker
 ...
 * @return DMSMoatWebTracker instance
 */
+ (DMSMoatWebTracker *)trackerWithWebComponent:(UIView *)webViewOrWebViewContainer;
...
+ (DMSMoatWebTracker *)trackerWithAdView:(UIView *)adView withWebComponent:(UIView *)webViewOrWebViewContainer;
