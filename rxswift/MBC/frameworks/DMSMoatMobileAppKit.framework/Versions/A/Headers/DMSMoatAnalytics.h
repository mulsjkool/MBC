...
@interface DMSMoatOptions : NSObject<NSCopying>
...
@interface DMSMoatAnalytics : NSObject
 ...
 * @see DMSMoatOptions
 */
- (void)startWithOptions:(DMSMoatOptions *)options;
 ...
 * @see DMSMoatVideoTracker.h for more detail on what constitues a native ad.
 *
