 ...
 */
@interface DMSMoatNativeDisplayTracker : DMSMoatBaseTracker
 ...
 * @return DMSMoatNativeDisplayTracker instance
 */
+ (DMSMoatNativeDisplayTracker *)trackerWithAdView:(UIView *)adView withAdIds:(NSDictionary *)adIds;
