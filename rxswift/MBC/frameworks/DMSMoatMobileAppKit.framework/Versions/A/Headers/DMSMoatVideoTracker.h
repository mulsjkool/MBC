 ...
 *
 * @warning This class will be removed in a future version of this SDK. We recommend using DMSMoatMPVideoTracker and DMSMoatAVVideoTracker instead of this class.
...
@interface DMSMoatVideoTracker : DMSMoatBaseTracker
 ...
 * @return DMSMoatVideoTracker instance
 */
+ (DMSMoatVideoTracker *)trackerWithPartnerCode:(NSString *)partnerCode;
