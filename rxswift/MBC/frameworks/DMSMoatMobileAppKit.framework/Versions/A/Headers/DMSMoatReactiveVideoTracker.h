...
#import "DMSMoatAdEvent.h"
#import "DMSMoatBaseVideoTracker.h"

typedef enum DMSMoatTrackerState : NSUInteger {
 ...
 *
 */
@interface DMSMoatReactiveVideoTracker : DMSMoatBaseVideoTracker

@property (assign, nonatomic, readonly) DMSMoatTrackerState state;
 ...
 *
 * @see DMSMoatAdEvent to see the required video ad events that must be reported to the SDK if they occur
 */
- (void)dispatchEvent:(DMSMoatAdEvent *)event;
